...
--
-- Dumping data for table `games_scores`
--

LOCK TABLES `games_scores` WRITE;
/*!40000 ALTER TABLE `games_scores` DISABLE KEYS */;
/*!40000 ALTER TABLE `games_scores` ENABLE KEYS */;
UNLOCK TABLES;
